      ...
      child: Column
        (
          ...
          [
                ...
                Text(mood.name,style: const TextStyle(
                color: Colors.white)),
          ],
      ),
      ),
  ...
  Widget _buildStatistics()
  {
        ...
        return Row
          (
            ...
            children:
          [
              Icon(mostFrequentMood.icon,
              color: mostFrequentMood.color,),
              const SizedBox(width: 10),
              Text('Most Frequent Mood: ${mostFrequentMood.name}',
